...
#TODO 做成动态
__C.TRAIN.SAVE_MODEL_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "models/zx_table/mask_rcnn_coco_{epoch:04d}.h5")
...
__C.TEST.SAVE_MODEL_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "models/zx_table/")
